...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.U_h_value.setMinimum(-5.0)
        self.U_h_value.setSingleStep(1.0)
        self.U_h_value.setProperty("value", 2.0)
        ...
        self.Omega_max_value.setProperty("value", 1.0)
        ...
        self.Delta_final_value.setProperty("value", 4.0)
        ...
        self.t_sweep_value_1.setProperty("value", 100.0)
        ...
        self.t_sweep_value_2.setProperty("value", 1300.0)
        ...
        self.Correlation_plot_button.setGeometry(QtCore.QRect(670, 370, 321, 28))
        ...
        self.Neel_structure_plot_button.setGeometry(QtCore.QRect(670, 430, 321, 28))
        self.Neel_structure_plot_button.setObjectName("Neel_structure_plot_button")
        self.Different_neighbors_plot_button = QtWidgets.QPushButton(self.centralwidget)
        self.Different_neighbors_plot_button.setGeometry(QtCore.QRect(670, 480, 321, 28))
        self.Different_neighbors_plot_button.setObjectName("Different_neighbors_plot_button")
        ...
        self.Clear_command = QtWidgets.QPushButton(self.centralwidget)
        self.Clear_command.setGeometry(QtCore.QRect(20, 560, 93, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Neel_structure_plot_button.setText(_translate("MainWindow", "Show Néel structure factoras a function of t"))
        self.Different_neighbors_plot_button.setText(_translate("MainWindow", "Show dependance on t for different nearest neighbors"))
        ...
        self.Clear_command.setText(_translate("MainWindow", "Clear"))
